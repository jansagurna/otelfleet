...
const (
	AuthService_ValidateAPIKey_FullMethodName = "/otelfleet.auth.v1.AuthService/ValidateAPIKey"
)
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "otelfleet.auth.v1.AuthService",
